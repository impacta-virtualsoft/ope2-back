...
LOCAL_APPS = [
    ...
    "backend.order.apps.CoreConfig",
    "backend.menu.apps.CoreConfig",
    "backend.product.apps.CoreConfig",
    "backend.inventory.apps.CoreConfig",
...
# django-rest-framework - https://django-rest-framework-simplejwt.readthedocs.io/en/latest/settings.html
SIMPLE_JWT = {
